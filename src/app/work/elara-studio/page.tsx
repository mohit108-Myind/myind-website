...
const budget = [
  { channel: "Meta Ads (IG + FB)", objective: "Awareness & Conversion", budget: "₹1,00,000" },
  { channel: "Google Search + Shopping", objective: "High-intent traffic", budget: "₹60,000" },
  { channel: "YouTube Shorts", objective: "Awareness", budget: "₹40,000" },
];
        ...
        <div className="mx-auto max-w-6xl px-4 md:px-6 -mt-14 relative z-10">
          <div className="rounded-2xl bg-white/95 backdrop-blur p-6 shadow-lg ring-1 ring-zinc-100">
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-[#101828]">ELARA Studio</h1>
                <p className="text-zinc-600 mt-1">Minimalist, high-quality everyday wear (Fashion · D2C)</p>
              </div>
              <div className="flex gap-3">
                <a
                  // add a real PDF later
  ...
  <a href="/#contact">Book a Discovery Call</a>
            ...
            <div className="mt-5 grid grid-cols-1 gap-3 md:grid-cols-3">
              {stats.map((s) => (
                <div
                  key={s.label}
                  className="rounded-xl bg-[#F9FAFB] p-4 ring-1 ring-zinc-100"
                >
      ...
      <section className="mx-auto max-w-6xl px-4 md:px-6 py-12 space-y-12">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div className="md:col-span-2">
            ...
            <p className="mt-3 text-zinc-700 leading-relaxed">
              ELARA Studio had strong visual identity and influencer buzz—but sales lagged.
              Conversion rate was under 1.2%, remarketing was fragmented, and awareness
              relied too heavily on collaborations. The brand needed a repeatable,
        ...
        <div>
          ...
          <div className="mt-5 grid gap-6 md:grid-cols-3">
            ...
            <div className="rounded-xl p-5 ring-1 ring-zinc-200">
              ...
              <p className="mt-2 text-sm text-zinc-700">
                Carousel “From desk to dinner” looks + product pages optimized; email signup
                for size guides and styling tips.
              </p>
            ...
            <div className="rounded-xl p-5 ring-1 ring-zinc-200">
              ...
              <p className="mt-2 text-sm text-zinc-700">
                Dynamic Product Ads to viewers and cart abandoners; limited-time incentives,
                and warm-audience lookalikes.
              </p>
              <div className="mt-3 text-xs text-zinc-500">KPIs: ROAS, CVR, CPA</div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="mt-2 text-zinc-600 text-sm">Creative concepts used in the campaign.</p>
  ...
  <div className="relative rounded-xl ring-1 ring-zinc-200 bg-white p-3">
    <div className="relative mx-auto w-full aspect-[9/16] rounded-[2rem] border border-zinc-300 bg-black overflow-hidden">
      ...
      <div className="pointer-events-none absolute left-3 bottom-3 z-10 text-white">
        ...
        <div className="text-sm font-medium">“Desk to Dinner” — Elara. For you!</div>
      </div>
    </div>
  </div>
...
<div className="relative rounded-xl ring-1 ring-zinc-200 bg-white p-3">
  <div className="relative mx-auto w-full aspect-[9/16] rounded-[2rem] border border-zinc-300 bg-black overflow-hidden">
    ...
    <div className="pointer-events-none absolute left-3 bottom-3 z-10 text-white">
      <div className="text-xs opacity-80">@elarastudio</div>
      <div className="text-sm font-medium">“3 Looks, 1 Blazer” — Carousel Ad</div>
    </div>
  </div>
</div>
 ...
 <div className="relative aspect-[9/16] overflow-hidden rounded-xl ring-1 ring-zinc-200 bg-black">
  ...
  <div className="absolute bottom-3 left-3 z-10 text-white">
    ...
    <p className="text-sm font-medium">“Your Cart Misses You” — DPA Retargeting Ad</p>
  </div>
</div>
</div>
</div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div>
            <h2 className="text-2xl font-semibold text-[#101828]">Budget & Channel Split</h2>
          ...
          <div>
            <h2 className="text-2xl font-semibold text-[#101828]">Performance Snapshot (45 days)</h2>
        ...
        <div className="rounded-2xl bg-[#F9FAFB] p-6 ring-1 ring-zinc-200 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h3 className="text-xl font-semibold text-[#101828]">Want results like this for your brand?</h3>
